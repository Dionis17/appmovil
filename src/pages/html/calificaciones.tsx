...
import '../css/califi.css'; // Asegúrate de tener el archivo CSS para aplicar los estilos.
    ...
    <IonPage>
      <IonContent>
        <div className="grade-form-container">
          <h2 className="form-title">Calificación de {studentName}</h2>

          {/* Selección del tipo de evaluación */}
          <IonItem className="styled-item">
            <IonLabel className="styled-label">Tipo de Evaluación</IonLabel>
            <IonSelect 
          ...
          <IonItem className="styled-item">
            <IonLabel className="styled-label">Calificación (0-100)</IonLabel>
            <IonInput
              type="number"
              value={grade}
              min={0}
              ...
              onIonFocus={handleFocus(setGrade)}
          ...
          {/* Campo de comentario */}
          <IonItem className="styled-item">
            <IonLabel className="styled-label">Comentario</IonLabel>
            <IonTextarea
              value={comment}
              onIonChange={(e) => setComment(e.detail.value!)}
              onIonFocus={handleFocus(setComment)}
          ...
          <IonButton  onClick={handleSubmit} className="submit-button">
            Enviar Calificación
          </IonButton>
        </div>
      </IonContent>
